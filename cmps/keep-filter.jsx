export class KeepFilter extends React.Component {
    ...
    render() {
        ...
        return <div className='keep-filter'>
            <input type="text" placeholder='search' value={name} onChange={this.handleChange} name="name" ref={this.byNameRef} className='keep-add-input' autoComplete="off"/>
            <select name="type" ref={this.byTypeRef} onChange={this.setFilter} className='keep-add-input'>
